...
func initialize(appKey:String, adTypes) -> void:
	_appodeal.connect("initialization_finished", Callable(self, "_initialization_finished")) #Emitted when initialization is complete
...
func connectSignals() -> void:
	_appodeal.connect("interstitial_loaded", Callable(self, "_interstitial_loaded")) # Emitted when interstitial has been loaded and cached (precached:bool)
	_appodeal.connect("interstitial_load_failed", Callable(self, "_interstitial_load_failed")) # Emitted when interstitial failed to load
	_appodeal.connect("interstitial_shown", Callable(self, "_interstitial_shown")) # Emitted when interstitial has started to show
	_appodeal.connect("interstitial_show_failed", Callable(self, "_interstitial_show_failed")) # Emitted when interstitial failed to show for some reason
	_appodeal.connect("interstitial_clicked", Callable(self, "_interstitial_clicked")) # Emitted when interstitial clicked
	_appodeal.connect("interstitial_closed", Callable(self, "_interstitial_closed")) # Emitted when interstitial was closed (the usual scenario when the gameplay continues)
	_appodeal.connect("interstitial_expired", Callable(self, "_interstitial_expired")) # Emitted when cached interstitial has expired and needs recache

	_appodeal.connect("banner_loaded", Callable(self, "_banner_loaded")) # Emitted when banner has been loaded (precached:bool)
	_appodeal.connect("banner_load_failed", Callable(self, "_banner_load_failed")) # Emitted when banner failed to load
	_appodeal.connect("banner_shown", Callable(self, "_banner_shown")) # Emitted when banner has been shown
	_appodeal.connect("banner_show_failed", Callable(self, "_banner_show_failed")) # Emitted when banner failed to show
	_appodeal.connect("banner_clicked", Callable(self, "_banner_clicked")) # Emitted when banner has been clicked
	_appodeal.connect("banner_expired", Callable(self, "_banner_expired")) # Emitted when banner has expired

	_appodeal.connect("rewarded_video_loaded", Callable(self, "_rewarded_video_loaded")) # Emitted when rewarded ad has been loaded and cached (precached:bool)
	_appodeal.connect("rewarded_video_load_failed", Callable(self, "_rewarded_video_load_failed")) # Emitted when rewarded ad failed to load
	_appodeal.connect("rewarded_video_shown", Callable(self, "_rewarded_video_shown")) # Emitted when rewarded ad has started to show
	_appodeal.connect("rewarded_video_show_failed", Callable(self, "_rewarded_video_show_failed")) # Emitted when rewarded ad failed to show for some reason
	_appodeal.connect("rewarded_video_clicked", Callable(self, "_rewarded_video_clicked")) # Emitted when rewarded ad clicked
	_appodeal.connect("rewarded_video_finished", Callable(self, "_rewarded_video_finished")) # Emitted when rewarded ad was viewed until the end, provides reward info (amount:float, currency:String)
	_appodeal.connect("rewarded_video_closed", Callable(self, "_rewarded_video_closed")) # Emitted when rewarded ad was closed (the usual scenario when the gameplay continues)
	_appodeal.connect("rewarded_video_expired", Callable(self, "_rewarded_video_expired")) # Emitted when cached rewarded ad has expired and needs recache

	_appodeal.connect("mrec_loaded", Callable(self, "_mrec_loaded")) # Emitted when MREC has been loaded (precached:bool)
	_appodeal.connect("mrec_load_failed", Callable(self, "_mrec_load_failed")) # Emitted when MREC failed to load
	_appodeal.connect("mrec_shown", Callable(self, "_mrec_shown")) # Emitted when MREC got shown
	_appodeal.connect("mrec_show_failed", Callable(self, "_mrec_show_failed")) # Emitted when MREC failed to show for some reason
	_appodeal.connect("mrec_clicked", Callable(self, "_mrec_clicked")) # Emitted when MREC has been clicked
	_appodeal.connect("mrec_expired", Callable(self, "_mrec_expired")) # Emitted when MREC has expired

	_appodeal.connect("ad_revenue_received", Callable(self, "_ad_revenue_received")) #Emitted when ad revenue has been received
	_appodeal.connect("iap_validate_success", Callable(self, "_iap_validate_success")) #Emitted when an IAP has successfully been validated via validateIAP()
	_appodeal.connect("iap_validate_failed", Callable(self, "_iap_validate_failed")) #Emitted when ad IAP has failed to validate via validateIAP()
